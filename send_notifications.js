...
// Use the local MongoDB URI as default, but fallback to the MONGODB_URI environment variable for production/Atlas!
...
async function run() {
  ...
  try {
    ...
    console.log("👉 To also send real outbound emails, run: npm install nodemailer inside your folder, set SMTP_USER/SMTP_PASS, and run this script again.\n");
  }
